...
# words. You, or another player, then construct a list of words and place them into 
# the story, creating an often silly or funny story as a result.
# 
...
puts "Today #{noun} #{verb} #{adjective} #{adverb}"
